...
public class MessageServiceImpl implements MessageService {
        ...
        @Override
        @Transactional
        public MessageResponse sendMessage(MessageRequest request, String senderId, String senderName,
                        String senderEmail) {
                ...
                String threadId = request.getThreadId() != null ? request.getThreadId()
                                ...
                                .map(messages -> {
                                        MessageDocument lastMsg = messages.stream()
                                                        .max(java.util.Comparator
                                                                        .comparing(MessageDocument::getCreatedAt))
                                                        .orElse(null);
